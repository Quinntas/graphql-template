 ...
 */
export abstract class Repo<Domain extends BaseDomain> {
    private readonly table: MySqlTable;
    private readonly db: MySql2Database;
    private readonly mapper: Mapper<Domain>;
    private readonly redisClient: RedisService;

    protected constructor(table: MySqlTable, db: MySql2Database, mapper: Mapper<Domain>, redisClient: RedisService) {
        this.table = table;
        this.db = db;
        this.mapper = mapper;
